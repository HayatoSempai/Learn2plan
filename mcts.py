...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  2 14:57:30 2020
...
class MonteCarloTreeSearch(object):
    ...
    def __init__(self, net):
        ...
        self.game = None
        self.net = net
        self.num_mcts_sims = num_mcts_sims = 15 # < game.hours
    ...
    def search(self, game, node, temperature):
        ...
        for i in range(self.num_mcts_sims):
            ...
            psa_vector, v = self.net.predict(game.state['state'])
            ...
            ''' TO BE COMPLETED !!! '''
            game_over, wsa = game.check_game_over()
    ...
    def add_dirichlet_noise(self, game, psa_vector):
        ...
        """
        dirichlet_input = [self.dirichlet_alpha for x in range(game.action_size)]
